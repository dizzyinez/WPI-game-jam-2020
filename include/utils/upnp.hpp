...
struct upnp
{
        ...
        {
                std::cout << "setting up upnp" << std::endl;
                ...
                std::cout << "UPNP device discovered!" << std::endl;
                ...
                if (status != 1)
                {
                        std::cout << "[Error] lan status: " << status << std::endl;
                        return false;
                }
                std::cout << "IGD found!" << std::endl;
        ...
        static bool upnp_open(int port)
        {
                ...
                error = UPNP_AddPortMapping(
                        ...
                        "6743",         // external (WAN) port requested
                        "6743",         // internal (LAN) port to which packets will be redirected
